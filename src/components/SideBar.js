      ...
      {isMenuOpen1 ? (
        <div className="flex w-42 shadow-md px-2 flex-col h-screen scroll-container">
          <div className="sec-1 px-4 border-b py-3 flex justify-start">
            <ul className="w-full">
                <Link to='/'>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg
                ...
                <p className="text-sm ml-7">Home</p>
              ...
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                ...
                <p className="text-sm ml-7">Shorts</p>
              </li>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg
                  enableBackground="new 0 0 24 24"
                ...
                <p className="text-sm ml-7">Subscriptions</p>
              </li>
            </ul>
          </div>
          <div className="sec-2 px-4 border-b py-3 flex flex-col justify-start">
            ...
            <ul className="w-full">
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                ...
                <p className="text-sm ml-7">Library</p>
              </li>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg
                  height="24"
                ...
                <p className="text-sm ml-7">History</p>
              </li>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg
                  height="24"
                ...
                <p className="text-sm ml-7">Watch Later</p>
              </li>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg
                  enableBackground="new 0 0 24 24"
                ...
                <p className="text-sm ml-7">Liked Video</p>
              </li>
            </ul>
          </div>
          <div className="sec-3 px-4 border-b py-3 flex flex-col justify-start">
            ...
            <ul className="w-full">
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                ...
                <p className="text-sm ml-7">Trending</p>
              </li>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg
                  height="24"
                ...
                <p className="text-sm ml-7">Shopping</p>
              </li>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg
                  enableBackground="new 0 0 24 24"
                ...
                <p className="text-sm ml-7">Music</p>
              </li>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg
                  height="24"
                ...
                <p className="text-sm ml-7">Movies</p>
              </li>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg
                  enableBackground="new 0 0 24 24"
                ...
                <p className="text-sm ml-7">Live</p>
              </li>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg
                  enableBackground="new 0 0 24 24"
                ...
                <p className="text-sm ml-7">Gaming</p>
              </li>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg
                  enableBackground="new 0 0 24 24"
                ...
                <p className="text-sm ml-7">News</p>
              </li>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg
                  height="24"
                ...
                <p className="text-sm ml-7">Sport</p>
              </li>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg
                  enableBackground="new 0 0 24 24"
                ...
                <p className="text-sm ml-7">Learning</p>
              </li>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg
                  height="24"
                ...
                <p className="text-sm ml-7">Fashion & Beauty</p>
              </li>
            </ul>
          </div>
          <div className="sec-4 px-4 border-b py-3 flex flex-col justify-start">
            <h1 className="font-semibold">More from Watch-Nest</h1>
            <ul className="w-full">
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                ...
                <p className="text-sm ml-7">Watch-Nest Premium</p>
              </li>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg viewBox="0 0 24 24" focusable="false" className="h-6 w-6">
                ...
                <p className="text-sm ml-7">Watch-Nest Music</p>
              </li>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg viewBox="0 0 24 24" focusable="false" className="h-6 w-6">
                  <path
                ...
                <p className="text-sm ml-7">Watch-Nest Kids</p>
              </li>
            </ul>
          </div>
          <div className="sec-5 px-4 py-3 flex flex-col justify-start">
            <ul className="w-full">
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg
                  enableBackground="new 0 0 24 24"
                ...
                <p className="text-sm ml-7">Setting</p>
              </li>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg
                  enableBackground="new 0 0 24 24"
                ...
                <p className="text-sm ml-7">Report History</p>
              </li>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg
                  enableBackground="new 0 0 24 24"
                ...
                <p className="text-sm ml-7">Help</p>
              </li>
              <li className="flex flex-row justify-left py-2 items-center cursor-pointer">
                <svg
                  enableBackground="new 0 0 24 24"
                ...
                <p className="text-sm ml-7">Send Feedback</p>
              </li>
            </ul>
          </div>
        </div>
      ) : (
        // <div className="flex px-2 flex-col h-screen">
        //   <div className="sec-1 px-3 py-3 flex justify-start">
        //     <ul className="w-full">
        //       <li className="flex flex-col justify-left py-4 items-center cursor-pointer">
        //         <Link to="/">
        //         <svg
        //           enableBackground="new 0 0 24 24"
        //           height="24"
